...
int main(int argc, char * argv[])
{
  ...
  typedef itk::Image< DVFPixelType, 4 > DVFInputImageType;
  typedef itk::Image< DVFPixelType, 3 > DVFOutputImageType;
  typedef rtk::CyclicDeformationImageFilter< DVFInputImageType, DVFOutputImageType > DeformationType;
